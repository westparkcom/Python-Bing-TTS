...
try:
    ...
    print ""
    print "Usage:", sys.argv[0], '--cache=/path/to/cache --dest=/path/to/destination/file.wav --lang=en-US --gender=Female --fileformat=riff-8khz-8bit-mono-mulaw --apikey=YOUR-API-KEY --text="Hello World"'
    print ""
    ...
    print "--gender        : Gender of the language to be spoken. Male or Female."
    ...
    print ""
    print "Available language combinations (--lang and --gender):"
...
try:
    ...
    print ""
    print "Usage:", sys.argv[0], '--cache=/path/to/cache --dest=/path/to/destination --lang=en-US --gender=Female --fileformat=riff-8khz-8bit-mono-mulaw --apikey=YOUR-API-KEY --text="Hello World"'
    print ""
    sys.exit(1)
...
try:
    ...
    print ""
    print "Usage:", sys.argv[0], '--cache=/path/to/cache  --dest=/path/to/destination --lang=en-US --gender=male --fileformat=riff-8khz-8bit-mono-mulaw --apikey=YOUR-API-KEY --text="Hello World"'
    print ""
    sys.exit(1)
    
try:
    ttsGender = argsDict['--gender'].title()
except:
    print ""
    print "Error: gender not specified."
    print ""
    print "Usage:", sys.argv[0], '--cache=/path/to/cache --dest=/path/to/destination --lang=en-US --gender=male --fileformat=riff-8khz-8bit-mono-mulaw --apikey=YOUR-API-KEY --text="Hello World"'
    print ""
    sys.exit(1)
...
try:
    servicename = namemap[ttsLang + ',' + ttsGender.title()]
except:
    print ""
